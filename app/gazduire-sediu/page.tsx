    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="container mx-auto py-12 px-4 mt-16 xl:mt-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-primaryColor mb-8">Găzduire Sediu Social</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-2xl font-semibold text-primaryColor mb-4">Ce include serviciul</h3>
            ...
            <h2 className="text-3xl font-bold text-primaryColor mb-6">Pachete disponibile</h2>

            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="border border-gray-200 rounded-lg p-6 text-center">
                <h4 className="text-xl font-semibold mb-4 text-primaryColor">Pachet Basic</h4>
                <div className="text-3xl font-bold text-primaryColor mb-4">99 RON/lună</div>
              ...
              <div className="border-2 border-blue-500 rounded-lg p-6 text-center relative">
                ...
                <div className="text-3xl font-bold text-primaryColor mb-4">199 RON/lună</div>
                <ul className="text-sm text-gray-600 space-y-2">
              ...
              <div className="border border-gray-200 rounded-lg p-6 text-center">
                ...
                <div className="text-3xl font-bold text-primaryColor mb-4">299 RON/lună</div>
                <ul className="text-sm text-gray-600 space-y-2">
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-primaryColor mb-3">Locația noastră</h3>
