...
export default function Page() {
  return (
    <>
      <Head>
        <title>Finanz Consult - Contabilitate, Înființări și Modificări Firme Online</title>
        <meta name="description" content="Servicii de contabilitate, înființare și modificare firme 100% online. Rapid, sigur și fără birocrație. Consultanță gratuită și suport dedicat." />
        <meta name="keywords" content="contabilitate, infiintare firma, modificare firma, PFA, SRL, gazduire sediu, consultanta fiscala, marca, online, Bucuresti" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Finanz Consult - Contabilitate, Înființări și Modificări Firme Online" />
        <meta property="og:description" content="Servicii de contabilitate, înființare și modificare firme 100% online. Rapid, sigur și fără birocrație." />
        <meta property="og:image" content="/images/logo.png" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://finanzconsult.ro/" />
        <link rel="canonical" href="https://finanzconsult.ro/" />
      </Head>
      <div className="min-h-screen overflow-x-hidden">
        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-20 left-10 w-32 h-32 bg-[#86bbd8]/20 rounded-full blur-3xl"></div>
            <div className="absolute bottom-20 right-10 w-40 h-40 bg-[#F6ae2d]/20 rounded-full blur-3xl"></div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-[#F26419]/20 rounded-full blur-2xl"></div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group relative bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col h-full">
                <div className="flex items-center mb-6">
                  <div className="w-16 h-16 bg-[#020F59] rounded-2xl flex items-center justify-center mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#020F59] font-medium">Soluții complete</p>
                  </div>
                </div>
                ...
                <div className="space-y-2 mb-6 flex-grow">
                  <div className="flex items-center text-sm text-gray-600">
                    <div className="w-2 h-2 bg-[#020F59] rounded-full mr-3"></div>
                ...
                <button
                  className="inline-flex items-center text-[#F26419]/90 hover:text-[#F26419] font-semibold transition-colors duration-300 mt-auto"
                >
              ...
              <div className="group relative bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col h-full">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#020F59] font-medium">Rapid și eficient</p>
                  </div>
                </div>
                <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              <div className="group relative bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col h-full">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#020F59] font-medium">Gestionare completă</p>
                  </div>
                </div>
                <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                <button
                  className="inline-flex items-center text-[#F26419]/90 hover:text-[#F26419] font-semibold transition-colors duration-300 mt-auto"
                >
                  <Link href="/modificari/srl" className="flex items-center w-full h-full">
                    Află mai mult <ArrowRight className="h-4 w-4 ml-2" />
                  </Link>
                </button>
              </div>
              ...
              <div className="group relative bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col h-full">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#020F59] font-medium">Adresă prestigioasă</p>
                  </div>
                </div>
                <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              <div className="group relative bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col h-full">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#020F59] font-medium">Asistență completă</p>
                  </div>
                </div>
                <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              <div className="group relative bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col h-full">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#020F59] font-medium">Protecție IP</p>
                  </div>
                </div>
                <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          <div className="container mx-auto px-4 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-center">
              ...
              <div className="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 flex flex-col justify-center">
                <div className="w-20 mx-auto h-20 bg-gradient-to-br from-[#020F59] to-[#0770bb] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              {/* Card 2 */}
              <div className="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 flex flex-col justify-center">
                <div className="w-20 h-20 mx-auto bg-gradient-to-br from-[#86bbd8] to-[#0770bb] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              {/* Card 3 */}
              <div className="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 flex flex-col justify-center">
                <div className="w-20 mx-auto h-20 bg-gradient-to-br from-[#F6ae2d] to-[#F26419] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="flex flex-col justify-center items-center h-full text-center px-4 md:px-8 lg:px-12">
                    ...
                    <p className="text-gray-700 text-lg leading-relaxed mb-4">
                      Suntem încântați să anunțăm că întregul departament <b className="text-[#1a2f6f] whitespace-nowrap">Financiar-Contabil</b> al <b className="text-[#1a2f6f] whitespace-nowrap">SRL Consult</b> se transformă în <b className="text-[#1a2f6f] whitespace-nowrap">Finanz Consult</b>! Această schimbare vine ca parte a strategiei noastre de expansiune și dezvoltare, menită să ne permită să oferim servicii și mai eficiente și adaptate nevoilor clienților noștri.
                    </p>
                    <p className="text-gray-700 text-lg leading-relaxed">
                      În contextul creșterii cererii pentru servicii financiare și contabile de înaltă calitate, am decis să ne extindem și să ne consolidăm sub noul brand <b className="text-[#1a2f6f] whitespace-nowrap">Finanz Consult</b>. Această transformare ne va permite să ne adaptăm mai bine la schimbările pieței și să oferim soluții inovatoare și personalizate pentru fiecare client.
                    </p>
                  </div>
                  {/* Coloana imagine */}
        ...
        {/* Stats Section */}
        <section className="py-16 bg-gradient-to-br from-[#86bbd8]/10 to-[#020F59]/10">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-[#F26419] mb-2">1000+</div>
                <div className="text-[#020F59] font-bold">Clienți mulțumiți</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-[#F26419] mb-2">15+</div>
                <div className="text-[#020F59] font-bold">Ani de experiență</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-[#F26419] mb-2">25+</div>
                <div className="text-[#020F59] font-bold">Membrii in echipa</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
              {[
                ...
                >
                  ...
                  <div className="pt-4 text-[#020F59] font-bold text-base  min-h-[3rem] flex items-center ">
                    {testimonial.name}
                  </div>
                </div>
              ))}
