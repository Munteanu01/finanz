    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="container mx-auto py-12 px-4 mt-16 xl:mt-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-primaryColor mb-8">Majorare/Micșorare Capital Social SRL</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-blue-50 p-6 rounded-lg mb-8">
              <h3 className="text-2xl font-semibold text-primaryColor mb-4">Serviciu modificare capital social</h3>
            ...
            <h2 className="text-3xl font-bold text-primaryColor mb-6">Tipuri de modificări</h2>
