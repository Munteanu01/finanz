    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="container mx-auto py-12 px-4 mt-16 xl:mt-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-blue-900 mb-8">Tarife Contabilitate</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-2xl font-semibold text-blue-900 mb-4">Tarife SRL</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-blue-200 pb-2">
                    <span className="font-medium">Pachet Basic (până la 20 operațiuni)</span>
                    <span className="text-blue-900 font-bold">150 RON/lună</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-blue-200 pb-2">
                    <span className="font-medium">Pachet Standard (până la 50 operațiuni)</span>
                    <span className="text-blue-900 font-bold">300 RON/lună</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-blue-200 pb-2">
                    <span className="font-medium">Pachet Premium (operațiuni nelimitate)</span>
                    <span className="text-blue-900 font-bold">500 RON/lună</span>
                  </div>
                </div>
              </div>
            ...
            <h2 className="text-3xl font-bold text-blue-900 mb-6">Servicii suplimentare</h2>

            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="border border-gray-200 rounded-lg p-4 text-center">
                <h4 className="text-lg font-semibold mb-2 text-blue-900">Bilanț anual</h4>
                <div className="text-2xl font-bold text-blue-900 mb-2">200 RON</div>
                <p className="text-sm text-gray-600">Întocmire și depunere bilanț</p>
              </div>

              <div className="border border-gray-200 rounded-lg p-4 text-center">
                <h4 className="text-lg font-semibold mb-2 text-blue-900">Declarație TVA</h4>
                <div className="text-2xl font-bold text-blue-900 mb-2">50 RON</div>
                <p className="text-sm text-gray-600">Per declarație lunară</p>
              </div>

              <div className="border border-gray-200 rounded-lg p-4 text-center">
                <h4 className="text-lg font-semibold mb-2 text-blue-900">Consultanță fiscală</h4>
                <div className="text-2xl font-bold text-blue-900 mb-2">100 RON/oră</div>
