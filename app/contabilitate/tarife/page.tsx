...
const payrollServicesPrices = {
  ...
  rows: [
    { service: "Deschidere contract individual de muncă", price: "90 lei" },
    { service: "Deschidere contract de telemuncă", price: "95 lei" },
    { service: "Încetare contract de muncă", price: "65 lei" },
    { service: "Înregistrare contract de mandat", price: "65 lei" },
    { service: "Declarație D205 pentru firme fără abonament contabil", price: "35 lei" },
    { service: "Decizie suspendare contract de muncă", price: "65 lei" },
    { service: "Administrare contract suspendat (pe lună completă)", price: "65 lei" },
    { service: "Depunere formular D700 pentru angajați", price: "150 lei" },
    { service: "Eliberare adeverință pentru medicul de familie/spital", price: "35 lei" },
    { service: "Întocmire fișă de post", price: "130 lei" },
    { service: "Redactare Regulament de Ordine Interioară", price: "800 lei" },
    { service: "Înregistrare declarații pentru subvenții salariale", price: "65 lei" },
    { service: "Înregistrare coasigurat", price: "90 lei" },
    { service: "Radiere coasigurat", price: "90 lei" },
    { service: "Administrare poprire angajat (pe lună)", price: "100 lei" },
    { service: "Întocmire act adițional la CIM", price: "100 lei" },
    { service: "Înregistrare concediu medical angajat", price: "100 lei" },
...
const consultingPrices = {
  ...
  headers: ["Denumire serviciu", "Tarif"],
  rows: [
    { service: "Întocmire bilanț interimar", price: "450 lei" },
    { service: "Întocmire bilanț anual/semestrial pentru firme fără venituri", price: "600 lei" },
    { service: "Întocmire bilanț anual/semestrial pentru microîntreprinderi cu cifra de afaceri <100.000 lei", price: "700 lei" },
    { service: "Întocmire bilanț anual/semestrial pentru microîntreprinderi cu cifra de afaceri 100.000 - 200.000 lei", price: "800 lei" },
    { service: "Întocmire bilanț anual/semestrial pentru microîntreprinderi cu cifra de afaceri 200.000 - 2.500.000 lei", price: "1100 lei" },
    { service: "Întocmire bilanț anual/semestrial pentru entități mici", price: "1700 lei" },
    { service: "Întocmire bilanț anual/semestrial pentru entități mijlocii și mari", price: "2500 lei" },
    { service: "Întocmire Declarație Unică (în funcție de complexitate)", price: "200-700 lei" },
    { service: "Depunere declarații rectificative pentru documente întarziate", price: "150 lei" },
    { service: "Depunere declarații fiscale speciale", price: "de la 200 lei" },
    { service: "Depunere Declarația 700 pentru alte modificări", price: "200 lei" },
    { service: "Achiziție Registru Unic de Control", price: "200 lei" },
    { service: "Obținere certificat de atestare fiscală", price: "150 lei" },
    { service: "Obținere cazier fiscal", price: "150 lei" },
    { service: "Obținere certificat de rezidență fiscală", price: "300 lei" },
    { service: "Obținere cod EORI", price: "300 lei" },
    { service: "Înființare PFI la ANAF", price: "600 lei" },
    { service: "Suspendare PFI la ANAF", price: "300 lei" },
    { service: "Radiere PFI la ANAF", price: "600 lei" },
    { service: "Înregistrare societate în scopuri de TVA", price: "600 lei" },
    { service: "Schimbare certificat TVA", price: "300 lei" },
    { service: "Cod TVA intracomunitar", price: "300 lei" },
    { service: "Reînregistrare TVA pentru firme cu cod anulat", price: "600 lei" },
    { service: "Anulare Cod Special TVA", price: "300 lei" },
    { service: "Depunere cerere eșalonare obligații bugetare", price: "500 lei" },
    ...
    { service: "Recuperare TVA Extern", price: "de la 250 lei" },
